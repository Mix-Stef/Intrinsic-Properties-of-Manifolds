...
In this notebook we study the simple cases of the 2-sphere and the 2-torus. The metric for the [2-sphere] is defined by the usual parametrization(http://www.physics.usu.edu/Wheeler/GenRel/Lectures/2Sphere.pdf). So does for the [torus](https://www.cefns.nau.edu/~schulz/torus.pdf). For the sphere, $\theta \in \[0, 2\pi)$ and $\phi \in \[0, \pi)$ while for the torus $\theta, \phi \in \[0, 2\pi)$.
