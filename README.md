...
In this notebook we study the simple cases of the 2-sphere and the 2-torus. We define the metric on the sphere: $\begin{bmatrix}R^{2}&0\\ 0&R^{2} \sin^{2}(\theta) \end{bmatrix}$
